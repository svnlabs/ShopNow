...
<div class=" content-area">
						<div class="page-header">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Update Deal</li>
							</ol>
						</div>
						...
						<div class="row row-deck">
							<div class="col-lg-12">
								<form class="card" method="post" action="{{route('deal.update', ['id' => $deal->id])}}" enctype="multipart/form-data">
									{{csrf_field()}}
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" name="title" class="form-control" placeholder="Give a name for your Deal" value="{{$deal->title}}">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" name="link" class="form-control" placeholder="Copy From Browser Url And paste Here" value="{{$deal->link}}">
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="input-group">
															...
															</div><input class="form-control " name="start_date" placeholder="MM/DD/YYYY" type="date"  value="{{$deal->start_date}}">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="input-group">
															...
															</div><input class="form-control " name="end_date" placeholder="MM/DD/YYYY" type="date"  value="{{$deal->end_date}}">
														</div>
													</div>
												</div>
											</div>
											<div class="col-md-12">
												...
												<div class=" card-body">
													<div class="row">
														...
														<div class="col-md-6">
															<img src="{{url($deal->back_image? 'dealimg/'.$deal->back_image:'images/noimage.jpg')}}" id="image_upload_preview" alt="Product Image" class="img-responsive" style="max-height: 180px">
														</div>
														<div class="col-lg-6 col-sm-12">
														...
														<div class="col-md-6">
															<img src="{{url($deal->front_image? 'dealimg/'.$deal->front_image:'images/noimage.jpg')}}" id="image_upload_preview" alt="Product Image" class="img-responsive" style="max-height: 180px">
														</div>
											...
											<div class="col-md-4">
												...
												<div class="form-group">
													...
													<label class="custom-switch">
														<input type="checkbox" name="is_active" class="custom-switch-input" {{$deal->is_active== 'on' ? 'checked' : ''}}>
