...
<div class=" content-area">
						...
						<div class="row row-deck">
							<div class="col-lg-12">
								<form class="card" method="post" action="{{route('product.store')}}">
									{{csrf_field()}}
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="input-group">
															...
															</div><input class="form-control fc-datepicker" name="special_price_start" placeholder="MM/DD/YYYY" type="text">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="input-group">
															...
															</div><input class="form-control fc-datepicker" name="special_price_end" placeholder="MM/DD/YYYY" type="text">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="input-group">
															...
															</div><input class="form-control fc-datepicker" name="new_from" placeholder="MM/DD/YYYY" type="text">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="input-group">
															...
															</div><input class="form-control fc-datepicker" name="new_to" placeholder="MM/DD/YYYY" type="text">
														</div>
													</div>
												</div>
											</div>
